...
const InternalResultForm = () => {
  ...
  return (
    <main className="internal">
      <h2 className="mb-2 mt-3 whitespace-break-spaces text-4xl font-bold text-slate-950 underline decoration-inherit decoration-2 underline-offset-4 dark:mt-0 dark:text-slate-400 md:text-6xl">
        Internal Mark
      </h2>
      <section className="form__head">
        <form className="w-full gap-4 accent-slate-900 md:flex">
          <select
            className="mb-4 block h-10 w-full rounded-md border-[1.5px] border-solid border-slate-400 p-1 pl-2 outline-none selection:border-slate-200 focus:border-slate-900 dark:border-slate-200 dark:caret-inherit dark:focus:border-slate-400 dark:active:border-slate-400 md:w-1/3"
          ...
          <button
            className="mb-4 h-10 w-auto rounded-md border-[1.5px] border-solid border-slate-900 bg-slate-800 px-8 py-2 font-semibold tracking-wide text-slate-200 hover:bg-slate-900 focus:bg-slate-900 disabled:cursor-not-allowed dark:border-slate-300 dark:bg-slate-900 dark:text-slate-100 dark:hover:bg-slate-900"
            type="submit"
        ...
        <form className="internal__body__form group">
                  ...
                  {internal?.map((student, index) => (
                    <tr
                      ...
                      className={
                        ...
                        12
                          ? "border-t-[1px] border-slate-400 bg-slate-900/50 first:border-none"
          ...
          {internal.length && disabled ? (
            <div className="flex gap-4">
              <button
                type="submit"
                className="mb-4 flex h-10 w-auto items-center gap-2 rounded-md border-[1.5px] border-solid border-slate-900 bg-slate-800 px-6 py-2 font-semibold tracking-wide text-slate-200 hover:bg-slate-900 focus:bg-slate-900 dark:border-slate-300 dark:bg-slate-900 dark:text-slate-100 dark:hover:bg-slate-900"
              ...
              <button
                type="submit"
                className="mb-4 flex h-10 w-auto items-center gap-2 rounded-md border-[1.5px] border-solid border-slate-900 bg-slate-800 px-6 py-2 font-semibold tracking-wide text-slate-200 hover:bg-red-700 focus:bg-slate-900 dark:border-slate-300 dark:bg-slate-900 dark:text-slate-100 dark:hover:bg-red-700"
          ...
          {internal.length && !disabled ? (
            <button
              type="submit"
              className="mb-4 flex h-10 group-invalid:hidden w-auto items-center gap-2 rounded-md border-[1.5px] border-solid border-slate-900 bg-slate-800 px-6 py-2 font-semibold tracking-wide text-slate-200 hover:bg-slate-900 focus:bg-slate-900 dark:border-slate-300 dark:bg-slate-900 dark:text-slate-100 dark:hover:bg-slate-900"
